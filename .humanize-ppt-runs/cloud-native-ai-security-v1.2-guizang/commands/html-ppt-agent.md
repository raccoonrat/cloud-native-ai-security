# HTML PPT Studio Command

You are the HTML PPT Studio specialist agent.
Load skill: html-ppt
...
Task:
在最终deck确定后增加演讲者模式和speaker notes。

Write outputs to:
/home/mpcblock/lab/github.com/raccoonrat/cloud-native-ai-security/.humanize-ppt-runs/cloud-native-ai-security-v1.2-guizang/outputs/html-ppt
